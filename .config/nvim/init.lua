...
-- Delete one char in insert mode
...
vim.keymap.set("n", "<C-p>", "<Esc>:tabp<CR>", { desc = "Focus previous tab" })
vim.keymap.set("n", "<C-n>", "<Esc>:tabn<CR>", { desc = "Focus next tab" })
...
require("lazy").setup({
	...
	{ -- Highlight, edit, and navigate code
		...
		config = function()
			...
			-- to hopefully fix the error "check your internet connection"
